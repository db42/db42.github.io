...
## Start using calender
This is to make sure that people can count on you.
Not quite a long time back, I wasn't a big fan of using calender and adding reminders. But now it has become a major compoenent of my work flow. 
Start using a calender - google, itunes what. Just remember to integrate it with your primary device Laptop, iPad , phone whatever. Whenever you have some future responsibility, some meeting(ouch!), a PR review or a discussion session with your buddy, just add it to your calender and forget about it. 
Even if you don't add it to the calender, you'll forget about it. Your mind can only keep a limited context and you wouldn't want to use it for mundane tasks such as reminders (I can geek about this to lenghts in a separate post).
